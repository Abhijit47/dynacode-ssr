    ...
    <div className='newsletter-bg'>
      <div className='card newsletter-card'>
        ...
        <p className='secondary-accent'>
          A diam maecenas sed enim ut sem viverra. Vulputate ut pharetra sit
          amet aliquam id diam maecenas ultricies. Ultricies mi quis hendrerit
          dolor. Convallis a cras semper auctor neque vitae tempus quam.
        </p>
          ...
          <div className='d-flex flex-column flex-md-row w-100 gspace-2'>
            <div className='d-flex w-100 flex-column gspace-2'>
              <input
                ...
                required
              />
              {error && <p className='error-text'>Message is required</p>}
            </div>
